...
# docker build -t report_management_app .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name report_management_app report_management_app
